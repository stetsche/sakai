...
public class ETSUserNotificationProviderImpl implements UserNotificationProvider {
	...
	public void notifyAboutJoinableSet(String siteName, User user, Group joinableGroup, boolean isNew) {
		...
		if (from != null) {
			...
			replacementValues.put("openDate", siteService.utcDateTimeToUserTimeZone(openDate, true));
			replacementValues.put("closeDate", siteService.utcDateTimeToUserTimeZone(closeDate, true));
