...
function showConfirmAdd(msgs, mainframeId){
	...
	$('<div></div>').appendTo('body')
		.html("<div><h6>" + msgs.syllabus_title + "<span class='highlight'> *</span></h6><input type='text' id='newTitle'/></div><div style='display:none' id='requiredTitle' class='messageError'>" + msgs.required + "</div>" +
